...
<br><br><br><br>
 <section class="secundaria">
        <form method="POST" action="Logic/instructorINS.php" enctype="multipart/form-data">
        <h1 id="adminis">Ingreso de Instructor:</h1><br><br>                
                ...
                <br>
                <input class= "buton1" type="submit" value="Ingresar instructor">
