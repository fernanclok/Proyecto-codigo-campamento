...
<html lang="en">
    ...
    <header>
        ...
        <form method="POST" action="Logic/delADMIN.php" enctype="multipart/form-data">
        <h1 id="adminis">Eliminar Administrador:</h1><br><br>
        <input class="entradas" type="text" name="txtid" maxlength="15" pattern="[0-9]" required placeholder="ID a eliminar">
                <br>
                <input class="buton1" type="submit" value="Eliminar Admin">
