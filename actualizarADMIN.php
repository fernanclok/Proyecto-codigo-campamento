...
<html lang="en">
    ...
    <header>
        ...
        <form method="POST" action="Logic/uptADMIN.php" enctype="multipart/form-data">
        <h1 id="adminis">Actualizar Datos de Administrador:</h1><br><br>
                <input class="entradas" type="text" name="txtid" maxlength="15" pattern="[0-9]" required placeholder="ID de administrador a actualizar">
                ...
                <br>
                <input class="buton1"type="submit" value="Actualizar Admin" >
